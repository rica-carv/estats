 ...
 * 
 * SVN FILE $Id: ar.php 417 2022-12-21 11:27:14Z joku $
 *  
...
"aero" => "طيراني",
"arpa" => "النمط القديم أربانيت",
"asia" => "آسيا والمحيط الهادئ",
"coop" => "تعاوني",
"info" => "معلومات",
"jobs" => "توظيف",
"mobi" => "الهواتف النقالة",
"name" => "شخصى",
"post" => "الخدمات البريدية",
...
<ul>
<li>id => رقم الزائر منذ بدأت العد</li>
<li>time => هو وقت أخر مرة دخل فيها الزائر الصفحة</li>
<li>visits => عدد الزيارات لزائر واحد بعينه</li>
<li>dns => إسم مضيف الزائر</li>
<li>ip => رقم الإنترنت بروتوكول للزائر</li>
<li>os => نظام التشغيل إذا كان متوفرا و\أو ليس روبوت</li>
<li>browser => البرنامج المستخدم لإجراء الإتصال</li>
<li>ext => دولة الزائر أو إمتداده</li>
<li>referer => الوصلة التى أتى منها الزائر إذا كان قد أتى من وصلة</li>
<li>page => أخر صفحة تم زيارتها</li>
<li>search => تبين كيفية بحث الزائر عن الموقع إذا توفرت</li>
</ul>
