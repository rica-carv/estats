 ...
 * 
 * SVN FILE $Id: uk.php 417 2022-12-21 11:27:14Z joku $
 *  
...
"aero" => "Aero",
"arpa" => "Помилки",
"asia" => "Азіатсько-Тихоокеанський регіон",
"coop" => "Coop",
"info" => "Інформаційні",
"jobs" => "Employmen",
"mobi" => "Мобільні ",
...
"an" => "Ндіерланди",
"ao" => "Ангола",
"ap" => "Азіатсько-Тихоокеанський регіон",
"aq" => "Антарктида",
"ar" => "Аргентина",
...
"gr" => "Греція",
"gs" => "Південна Георгія та Південні Сандвічеві острови",
"gt" => "Гватемала",
"gu" => "Гуам",
"gw" => "Гвінея-Бісау",
"gy" => "Гайана",
"hk" => "Гонконг",
"hm" => "Херд і МакДональд острови",
"hn" => "Гондурас",
"hr" => "Хорватія",
"ht" => "Гаїті",
"hu" => "Угорщина",
...
// Global translation
"global_titlebar"=> "Статистика за %SERVER генерується на %DATE",
...
"dstat_robots" => "роботи",
"dstat_my_visit" => "Переглядів з вашого IP",
...
"dstat_whois_information" => "Подивіться інформацію з цього IP адреса",
...
"tstat_average" => "середній",

// Loadtime notice
"generated" => "сторінка згенеровано за ",
"seconds" => " секунди",
