 ...
 * 
 * SVN FILE $Id: zh-cn.php 417 2022-12-21 11:27:14Z joku $
 *  
...
// Language: Simplified Chinese (中文(简体))
...
// Global translation
"global_titlebar"=> "统计 %SERVER 产生的 %DATE",
"global_bbclone_copyright" => "该 BBClone 团队 -- 许可遵从:",
"global_last_reset" => "统计数字起始自",
"global_yes" => "是",
"global_no" => "否",
...
"dstat_red_rows" => "红色行",
"dstat_search" => "搜索",
"dstat_last_page" => "最后一页",
"dstat_last_visit" => "最后的访问时间",
"dstat_robots" => "机器人",
"dstat_my_visit" => "从你的IP访问",
"dstat_no_data" => "无可用数据",
"dstat_prx" => "代理服务器",
"dstat_ip" => "IP地址",
"dstat_user_agent" => "用户代理",
"dstat_nr" => "N数",
"dstat_pages" => "页",
"dstat_visit_length" => "访问时长",
"dstat_reloads" => "重整",
"dstat_whois_information" => "查查资料共享这一个",
